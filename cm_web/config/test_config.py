...
class Config( object ):
    ...
    SQLALCHEMY_DATABASE_URI = \
            "postgresql+psycopg2://lumbarv2:housebird@localhost:5434/cm_db"
    ...
    CACHE_REDIS_URL         = 'redis://:duocisthemostsunnysite@localhost:6378/5'
...
#    REDIS_DATABASE          = 0             # deprecated
    REDIS_URL               = 'redis://:duocisthemostsunnysite@localhost:6378/6'
