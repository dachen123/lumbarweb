...
access_key_id = Config.get('OSS_ACCESS_KEY_ID', '<你的AccessKeyId>')
access_key_secret = Config.get('OSS_ACCESS_KEY_SECRET', '<你的AccessKeySecret>')
bucket_name = Config.get('OSS_BUCKET', '<你的Bucket>')
endpoint = Config.get('OSS_ENDPOINT', '<你的访问域名>')
sts_role_arn = Config.get('OSS_STS_ARN', '<你的Role Arn>')
